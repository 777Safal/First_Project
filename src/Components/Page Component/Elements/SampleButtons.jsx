...
function SampleButtons() {
    const data=[
      ...
      {h1:'info',color:'bg-info' ,textColor:'text-scholarship1',border:true,borderColor:'border-scholarship1},
      {h1:'Warning',textColor:'text-scholarship1',border:true,borderColor:'border-scholarship1'},
