...
function About() {
  ...
  return (
    <div className='w-full'>
        <div className='bg-cover bg-no-repeat w-full h-60 bg-bottom flex items-center justify-center
        ...
        <div className='w-full relative bg-white'>
                ...
                <div className='w-[360px] h-[500px] absolute top-[600px] right-20
                  bg-cover bg-no-repeat bg-center
                 bg-[url(https://scontent.fktm9-2.fna.fbcdn.net/v/t39.30808-6/319795753_729166351465028_8175149592448094006_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=8bfeb9&_nc_ohc=r_IFm6S8FGUAX96Ul_A&_nc_ht=scontent.fktm9-2.fna&oh=00_AfBJZF50ZFB8njWYvJrapev4NqWC5l5L6PFM7ETBZ6aEtw&oe=64A5CF6F)]'></div>
        </div>
    </div>
  )
}
